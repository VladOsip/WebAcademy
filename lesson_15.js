...
Playground.prototype.addCar = function (index) {
  ...
  var finishLineCoord = 450;
  var x = 0;
  var y = 50 * index;

  var finisheCallback = function finisheCallback(params) {
    console.log("FINISHED ", params);
  };

  var car = new _car__WEBPACK_IMPORTED_MODULE_0__["Car"](this.el, carName, carSpeed, 0, 50 * index, finishLineCoord, finisheCallback);
  car.render();
  car.move();
};

Playground.prototype.startGame = function () {
  var carsCount = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 2;
